...
mlflow.set_experiment("PredictiveMaintanence")

api = HfApi()


Xtrain_path = "hf://datasets/Shalyn/predictiveMaintanence/Xtrain.csv"
Xtest_path = "hf://datasets/Shalyn/predictiveMaintanence/Xtest.csv"
ytrain_path = "hf://datasets/Shalyn/predictiveMaintanence/ytrain.csv"
ytest_path = "hf://datasets/Shalyn/predictiveMaintanence/ytest.csv"
...
with mlflow.start_run():
    ...
    model_path = "engine_condition_model_v1.joblib"
    ...
    api.upload_file(
        path_or_fileobj="engine_condition_model_v1.joblib",
        path_in_repo="engine_condition_model_v1.joblib",
        repo_id=repo_id,
        repo_type=repo_type,
    )
